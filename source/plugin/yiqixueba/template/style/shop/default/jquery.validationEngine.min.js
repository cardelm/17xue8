	...
	$.validationEngineLanguage = {
		newLang:function(){
			$.validationEngineLanguage.allRules = {
				...
				"e|m":{
				   "regex":/^1[3458][\d]{9}$|^[\w\-\.]+@[\w\-]+(\.[\w\-]+)*(\.[a-z]{2,})\s*$/,
					"alertText":"* 无效的邮箱或手机号码"
				...
				"ajaxEmailCallPhp":{
					// remote json service location
					"url":"/ajax/ajaxValidateEmail.php",
					"alertTextOk":"* 此邮箱可以使用",
					// error
