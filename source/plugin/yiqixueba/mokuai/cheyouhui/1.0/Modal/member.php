...
class table_member extends discuz_table{
	...
	public function create() {
		...
		$fields = "
			...
			`membertitle` varchar(40) NOT NULL default '',
			`membersort` varchar(40) NOT NULL default '',
			`memberimages` varchar(40) NOT NULL default '',
