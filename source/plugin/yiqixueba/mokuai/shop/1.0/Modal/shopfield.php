...
class table_shopfield extends discuz_table{

	public function __construct() {
		$this->_table = 'shopfield';
		$this->_pk    = 'shopfieldid';
		parent::__construct();
	}
	...
	public function create() {
		...
		//////////////////////////
		$fields = "
			`shopfieldid` smallint(6) NOT NULL auto_increment,
			`shopfieldname` varchar(40) NOT NULL default '',
			`shopfieldtitle` varchar(40) NOT NULL default '',
			`shopfieldsort` varchar(40) NOT NULL default '',
			`shopfieldimages` varchar(40) NOT NULL default '',
	...
	public function fetch_by_shopfieldid($shopfieldid) {
		$mokuai_info = array();
		if($mokuaiid) {
